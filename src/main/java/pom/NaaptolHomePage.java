...
public class NaaptolHomePage {
	...
	@FindBy(xpath = "(//div[@class='search']//a)[2]")
	private WebElement search;
	@FindBy(xpath = "(//a[@id='cart-panel-link'])[2]")
	private WebElement cart;
	@FindBy(xpath = "//div[@id='mainMenuContent']//ul//li[1]//a//span")
	private WebElement listItem;
	@FindBy(xpath = "//div[@class='grid_Square ']")
	private List<WebElement> productList;
	@FindBy(xpath = "//h2[text()='Track Order']")
	private WebElement trackordertitle;
